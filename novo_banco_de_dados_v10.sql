...
-- object: public.etapa_obra | type: TABLE --
-- DROP TABLE IF EXISTS public.etapa_obra CASCADE;
CREATE TABLE public.etapa_obra (
	cod_obra integer NOT NULL,
	cod_etapa integer NOT NULL,
	CONSTRAINT etapa_obra_pk PRIMARY KEY (cod_obra,cod_etapa)

);
-- ddl-end --
-- ALTER TABLE public.etapa_obra OWNER TO postgres;
-- ddl-end --

-- object: obra_fk | type: CONSTRAINT --
-- ALTER TABLE public.etapa_obra DROP CONSTRAINT IF EXISTS obra_fk CASCADE;
ALTER TABLE public.etapa_obra ADD CONSTRAINT obra_fk FOREIGN KEY (cod_obra)
REFERENCES public.obra (cod) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: etapa_fk | type: CONSTRAINT --
-- ALTER TABLE public.etapa_obra DROP CONSTRAINT IF EXISTS etapa_fk CASCADE;
ALTER TABLE public.etapa_obra ADD CONSTRAINT etapa_fk FOREIGN KEY (cod_etapa)
...
-- ALTER TABLE public.consumo_mat_serv DROP CONSTRAINT IF EXISTS tarefa_fk CASCADE;
ALTER TABLE public.consumo_mat_serv ADD CONSTRAINT tarefa_fk FOREIGN KEY (cod_tarefa)
